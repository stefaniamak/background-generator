...
# Step 2: Run dart generate and build on main branch
echo "🎯 Step 2: Running dart generate..."
...
# Step 6: Update docs folder with the built files
...
# Step 7: Stage all changes and commit in one go
